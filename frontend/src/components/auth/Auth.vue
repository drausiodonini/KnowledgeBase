        ...
        <div class="auth-modal">
            ...
            <div class="login-wrap">
                <div class="login-html">
                    ...
                    <input id="tab-2" type="radio" name="tab" class="sign-up" value="signup" v-model="checked">
                    ...
                    <div class="login-form">
                        ...
                        <div class="sign-up-htm">
                            <div class="group">
                                ...
                                <input id="user" type="text" class="input" v-model="user.name">
                            </div>
                            <div class="group">
...
.login-wrap {
    ...
    min-height: 670px;
    position: relative;
    background: url('../../assets/carro-red.jpg')
        no-repeat center;
